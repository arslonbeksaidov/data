...
$AllCategoryCourse = new CourseCategory();
$results = $AllCategoryCourse->getAllCategory();
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <p class="card-title"><a href="/admin/resours/course/addCourseCategory.php" class="btn btn-success">Yangi Kurs qo'shish</a></p>
                             <p class="card-title float-right"><a href="/admin/resours/displayCourse/displayCourse.php" class="btn btn-success"> Kurslar haqida</a></p>
...
<!--                                            <a href="/admin/app/Category.php?updatePage=--><?//= $value['id']; ?><!-- " type="button" class="btn btn-success">O'zgartirish</a>-->
                                            <a href="/admin/app/CourseCategory.php?delete=<?= $value['id']; ?> " type="button" class="btn btn-danger">O'chirish</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
