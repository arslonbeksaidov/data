...
if (isset($_REQUEST['findMessage'])){
    $id =intval($_REQUEST['findMessage']);
    $results = $AllUnReadMessages->findMessage($id);
}
                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tr>
                                    ...
                                    <td>Xabar jonatgan vaqti</td>
                                    <td><?=date('Y/m/d - h:i',$results['created_at'])?></td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
