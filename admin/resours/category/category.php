                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title"><a href="/admin/resours/category/addCategory.php" class="btn btn-success">Yangi kategoriya qo'shish</a></h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                            <table id="example1" class="table table-bordered table-striped">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="#" type="button" class="btn btn-success">O'zgartirish</a>
                                        <a href="/admin/app/Category.php?delete=<?= $value['id']; ?> " type="button" class="btn btn-danger">O'zgartirish</a>
                                    </td>
                                </tr>
                                <?php
                                endforeach;
