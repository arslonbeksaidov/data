                    ...
                    <div class="col-md-6 ">
                        ...
                        <div class="card card-primary">
                            <div class="card-header">
                                <h3 class="card-title">Kategoriya qoshish</h3>
                            </div>
                            <!-- /.card-header -->
                            <!-- form start -->
                            <form role="form" method="post" action="/admin/app/Category.php">
                                <div class="card-body">
                                    <div class="form-group">
                                        <label for="kategoriya">Kategoriya</label>
                                        <input type="text" value="<?= $results['data0']['name'] ?>" name="cat_name"  class="form-control" id="kategoriya"
                                               placeholder="<?= $results['data0']['name'] ?>">
                                    </div>
                                ...
                                <div class="card-footer">
                                    <button type="submit" name="sendUpdatedData" value="<?php echo $results['data0']['id']?>" class="btn btn-primary">Submit</button>
                                </div>
                            </form>
                        </div>
                        <!-- /.card -->
