...
$results = $AllUnReadMessages->getAllMessages();


$messages = $AllUnReadMessages->getUnReadMessages();
$NumberAll = $AllUnReadMessages->getNumberMessages();
                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        <div class="card-header">
                            <h3 class="card-title text-danger">Hamma habarlar</h3>
                        </div>
                        <!-- /.card-header -->
                        <div class="card-body">
                                ...
                                foreach ($results as $value):
                                    ...
                                    <tr>
                                        ...
                                        <td><?php
                                            if ($value['isSeen']=='0'){
                                                echo 'o\'qilmagan';
                                            }elseif ($value['isSeen']==1){
                                                echo 'o\'qilgan';
                                            }
                                            ?></td>
                                        <td><?= date('Y/m/d h:i',$value['created_at']) ?>
                                        </td>
                                        <td>
                                            <a href="/admin/app/Statistics.php?delete=<?= $value['id']; ?> " type="button" class="btn btn-danger">O'chirish</a>
                                        </td>
                                    </tr>
                                <?php
                                endforeach;
