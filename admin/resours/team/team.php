...
$messages = $AllTeam->getUnReadMessages();
$NumberAll = $AllTeam->getNumberMessages();
                            ...
                            <table id="example1" class="table table-bordered table-striped table-responsive ">
                                ...
                                foreach ($results as $value):
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $value['insta'] ?>
                                        <td><?= $value['tel'] ?>
                                        <td><img width="100px" height="100px" src="/admin/team_photo/<?=$value['image']?>" alt="">
                                        </td>
                                        <td>
                                            <a href="/admin/app/Post.php?<?='delete_team_id='. $value['id'] ?> " type="button"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">Jamoani yaratish</h4>
                    ...
                    <div class="card card-primary">
                        ...
                        <form autocomplete="on" role="form" enctype="multipart/form-data"  method="post" action="/admin/app/Post.php" id="post-form">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="text" name="position" class="form-control" id="post"
                                ...
                                <div class="form-group">
                                    <textarea type="text" name="insta" class="form-control" id="post"
                                              placeholder="Instagram"></textarea>
                                </div>
                                <div class="form-group">
                                    <input type="tel" name="tel" class="form-control" id="post"
                                           placeholder="Telefon">
                                </div>
                                <div class="form-group">
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input type="file" name="imageTeam" class="custom-file-input" id="exampleInputFile">
                                            <label class="custom-file-label" for="exampleInputFile">Rasm tanla</label>
                                        </div>
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="">Yukla</span>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="modal-footer justify-content-between">
                    ...
                    <button type="submit" name="add_team_info" value="add_team_info" form="post-form" class="btn btn-primary">Yaratish</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
